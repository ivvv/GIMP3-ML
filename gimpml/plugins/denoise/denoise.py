...
def denoise(procedure, image, drawables, force_cpu, progress_bar, config_path_output):
    ...
    if data_output["inference_status"] == "success":
        load_single_result_and_insert(RESULT_IMG, image, "Denoised")
        ...
        show_dialog(
            "Denoising was not performed due to errors.\nError text:\n" + elog,
...
def run(procedure, run_mode, image, n_drawables, layer, args, data):
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        python_path = config_path_output["python_path"]
        config_path_output["plugin_path"] = os.path.join(config_path, PLUGIN_ID, "denoise.py")
        ...
        dialog.add_button(_("_Denoise"), Gtk.ResponseType.OK)
