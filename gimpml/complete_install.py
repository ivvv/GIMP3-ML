"""
Script will download weights and create gimp_ml_config.json, and print path to be added to GIMP Preferences.
"""
import os
import sys
import json
...
def setup_python_weights(install_location=None):
    ...
    with open(os.path.join(plugin_loc, CONFIG_FILE), "w") as file:
        json.dump({"python_path": python_path, "weight_path": weight_path}, file)
